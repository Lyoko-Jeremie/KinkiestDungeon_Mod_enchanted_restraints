...
export const StringTable_EN: StringTableType = {
    ...
    isAutoInstallEnchantedRestraintsPatch: 'isAutoInstallEnchantedRestraints',
    ...
    'Dynamic Hook Cheats Section': 'Dynamic Hook Cheats Section',
    DynamicHookEnableAlwaysCanUseAnyWeapon: 'EnableAlwaysCanUseAnyWeapon',
    DynamicHookDisableAlwaysCanUseAnyWeapon: 'DisableAlwaysCanUseAnyWeapon',
    DynamicHookEnableAlwaysCanDrink: 'EnableAlwaysCanDrink',
    DynamicHookDisableAlwaysCanDrink: 'DisableAlwaysCanDrink',
    DynamicHookEnableNeverMiscastMagic: 'EnableNeverMiscastMagic',
    DynamicHookDisableNeverMiscastMagic: 'DisableNeverMiscastMagic',
    DynamicHookEnableNeverSlow: 'EnableNeverSlow',
    DynamicHookDisableNeverSlow: 'DisableNeverSlow',
    DynamicHookEnableNeverMiss: 'EnableNeverMiss',
    DynamicHookDisableNeverMiss: 'DisableNeverMiss',
    DynamicHookEnableAlwaysCanUseMagic: 'EnableAlwaysCanUseMagic',
    DynamicHookDisableAlwaysCanUseMagic: 'DisableAlwaysCanUseMagic',
    ...
    ChoiceAddCheatChoiceSex: 'ChoiceAddCheatChoiceSex',
    ChoiceAddCheatChoiceSexRemove: 'ChoiceAddCheatChoiceSexRemove',
    ChoiceAddCheatChoiceSexClean: 'ChoiceAddCheatChoiceSexClean',
    ...
    ChoiceAddCheatChoiceMoreKinkyFurniture: 'ChoiceAddCheatChoiceMoreKinkyFurniture',
    ChoiceAddCheatChoiceMap: 'ChoiceAddCheatChoiceMap',
    ChoiceAddCheatChoiceMapAbsurd: 'ChoiceAddCheatChoiceMapAbsurd',
    ...
    AllRestraintItemSection: 'AllRestraintItem Section',
    AllRestraintItemSelect: 'AllRestraintItemSelect',
    NowWearRestraintItemSection: 'NowWearRestraintItem Section',
    NowWearRestraintItemSelect: 'NowWearRestraintItemSelect',
    WearTheSelectedRestrain: 'WearTheSelectedRestrain',
    AllRestraintItemFilterSection: 'AllRestraintItem and Curse Section',
    ...
    CurseWearIt: 'CurseWearIt(SelectWears OR RandomWears)',
    ...
    FillMapAsTrap: 'FillMapAsTrap',
    FillMap0AsTrap: 'FillMap0AsTrap',
    FillMap2AsTrap: 'FillMap2AsTrap',
