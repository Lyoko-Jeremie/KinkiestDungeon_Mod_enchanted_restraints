...
export const StringTable_CN: StringTableType = {
    ...
    BootstrapSpellChoicesTable: '【开局】快速设置为Mod预设法术列表（需先开启全部法术列表）',
    BootstrapFullAllSpells: '【开局】开启全部法术列表',
    BootstrapSimpleGood: '【开局】快速开启增益及动态作弊【风灵月影宗外门入口】',
    ...
    'Dynamic Hook Cheats Section': '动态作弊 Section',
    DynamicHookEnableAlwaysCanUseAnyWeapon: '启用 总能使用任何武器',
    DynamicHookDisableAlwaysCanUseAnyWeapon: '禁用 总能使用任何武器',
    DynamicHookEnableAlwaysCanDrink: '启用 总能喝药',
    DynamicHookDisableAlwaysCanDrink: '禁用 总能喝药',
    DynamicHookEnableNeverMiscastMagic: '启用 魔法永不失败',
    DynamicHookDisableNeverMiscastMagic: '禁用 魔法永不失败',
    DynamicHookEnableNeverSlow: '启用 永不减速',
    DynamicHookDisableNeverSlow: '禁用 永不减速',
    DynamicHookEnableNeverMiss: '启用 永不Miss',
    DynamicHookDisableNeverMiss: '禁用 永不Miss',
    DynamicHookEnableAlwaysCanUseMagic: '启用 总能使用魔法',
    DynamicHookDisableAlwaysCanUseMagic: '禁用 总能使用魔法',
    ...
    ChoiceAddCheatChoiceSex: '添加性兴奋Choice',
    ChoiceAddCheatChoiceSexRemove: '移除性兴奋Choice',
    ChoiceAddCheatChoiceSexClean: '添加冷静Choice',
    ...
    ChoiceAddCheatChoiceMoreKinkyFurniture: '添加更多古怪的家具Choice',
    ChoiceAddCheatChoiceMap: '添加地图最大化（下一次生成的地图才生效）',
    ChoiceAddCheatChoiceMapAbsurd: '启用试验性大地图（下一次生成的地图才生效）',
    ...
    AllRestraintItemSection: '所有可用的穿戴 Section',
    AllRestraintItemSelect: '所有可用的穿戴',
    NowWearRestraintItemSection: '已经穿戴的物品 Section',
    NowWearRestraintItemSelect: '已经穿戴的物品',
    WearTheSelectedRestrain: '穿上选择的物品',
    AllRestraintItemFilterSection: '所有可用的穿戴搜索及诅咒穿戴 Section',
    ...
    FillMapAsTrap: '用陷阱填充地图',
    FillMap0AsTrap: '用陷阱填充地图的一半',
    FillMap2AsTrap: '用陷阱填充地图的另一半',
