...
// from GPT-4
export function playDing(playHz: PlayDingType) {
    // @ts-ignore
    ...
    gainNode.gain.linearRampToValueAtTime(maxVolume, audioContext.currentTime + 0.01); // 音量从0快速上升到1
